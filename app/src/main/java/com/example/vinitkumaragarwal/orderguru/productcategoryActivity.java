...
public class productcategoryActivity extends AppCompatActivity {
    ...
    private List<productcategorydao> data_list;
    AsyncHttpClient asyncHttpClient;
    RequestParams requestParams;
    String BASE_URL = "https://apex.oracle.com/pls/apex/buysell/productcategory/productcategorylist/";
    String jsonResponse;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter =  new productcategoryadapter(this,data_list);
        ...
        NVmenu.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()){
                    ...
                    case R.id.dashboard:
                        mDrawerLayout.closeDrawers();
                        Intent myIntent = new Intent(productcategoryActivity.this, DashboardActivity.class);
                        startActivity(myIntent);
                        return true;
                    case R.id.client:
                        mDrawerLayout.closeDrawers();
                        Intent IntentClient = new Intent(productcategoryActivity.this, client.class);
                        startActivity(IntentClient);
                        return true;
                    case R.id.supplier:
                        Log.i("vinit>>>","s1111111");
                        //mDrawerLayout.closeDrawers();
                        Intent Intentsupplier = new Intent(productcategoryActivity.this, supplierActivity.class);
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try{
                    ...
                    for(int i=0; i<array.length();i++)
                    {
                        ...
                        productcategorydao data = new productcategorydao(object.getInt("id_product_category"), object.getString("product_category"), object.getString("product_category_link") );
                        data_list.add(data);
    ...
    private void filter(String text){
        ArrayList<productcategorydao> filteredList = new ArrayList<>();
        for(productcategorydao item :data_list)
        {
