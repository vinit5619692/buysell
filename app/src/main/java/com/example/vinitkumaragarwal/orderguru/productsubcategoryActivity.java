...
import com.example.vinitkumaragarwal.orderguru.adapter.productcategoryadapter;
...
public class productsubcategoryActivity extends AppCompatActivity {
    ...
    private productsubcategoryadapter adapter;
    private List<productsubcategorydao> data_list;
    AsyncHttpClient asyncHttpClient;
    RequestParams requestParams;
    String BASE_URL = "https://apex.oracle.com/pls/apex/buysell/productsubcategory/productsubcategorylist/";
    String jsonResponse;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_productsubcategory);
        getSupportActionBar().setTitle("Product Sub Category");
        ...
        adapter =  new productsubcategoryadapter(this,data_list);
        ...
        NVmenu.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()){
                    ...
                    case R.id.dashboard:
                        mDrawerLayout.closeDrawers();
                        Intent myIntent = new Intent(productsubcategoryActivity.this, DashboardActivity.class);
                        startActivity(myIntent);
                        return true;
                    case R.id.client:
                        mDrawerLayout.closeDrawers();
                        Intent IntentClient = new Intent(productsubcategoryActivity.this, client.class);
                        startActivity(IntentClient);
                        return true;
                    case R.id.supplier:
                        Log.i("vinit>>>","s1111111");
                        //mDrawerLayout.closeDrawers();
                        Intent Intentsupplier = new Intent(productsubcategoryActivity.this, supplierActivity.class);
                        startActivity(Intentsupplier);
                        return true;
                    case R.id.product:
                        Log.i("vinit>>>","s1111111");
                        //mDrawerLayout.closeDrawers();
                        Intent Intentproductcate = new Intent(productsubcategoryActivity.this, productcategoryActivity.class);
        ...
        executeLoopjCall(getIntent().getStringExtra("idproductcategory"));
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try{
                    ...
                    for(int i=0; i<array.length();i++)
                    {
                        ...
                        productsubcategorydao data = new productsubcategorydao(object.getInt("id_product_sub_category"),object.getInt("id_product_category"), object.getString("product_sub_category"), object.getString("product_sub_category_link") );
                        data_list.add(data);
    ...
    private void filter(String text){
        ArrayList<productsubcategorydao> filteredList = new ArrayList<>();
        for(productsubcategorydao item :data_list)
        {
